...
pub unsafe fn init_idt() -> () {
    ...
    _IDT[1] = IDTEntry::init_entry(isr_handlers::debug as u64, 0);
    _IDT[2] = IDTEntry::init_entry(isr_handlers::non_maskable_interrupt as u64, 0);
    _IDT[3] = IDTEntry::init_entry(isr_handlers::breakpoint as u64, 0);
    _IDT[4] = IDTEntry::init_entry(isr_handlers::overflow as u64, 0);
    _IDT[5] = IDTEntry::init_entry(isr_handlers::bound_range_exceeded as u64, 0);
    _IDT[6] = IDTEntry::init_entry(isr_handlers::invalid_opcode as u64, 0);
    _IDT[7] = IDTEntry::init_entry(isr_handlers::device_not_avaiable as u64, 0);
    ...
    _IDT[16] = IDTEntry::init_entry(isr_handlers::x87_floating_point as u64, 0);
    _IDT[17] = IDTEntry::init_entry(isr_handlers::alignment_check as u64, 0);
    _IDT[18] = IDTEntry::init_entry(isr_handlers::machine_check as u64, 0);
    _IDT[19] = IDTEntry::init_entry(isr_handlers::simd as u64, 0);
    _IDT[20] = IDTEntry::init_entry(isr_handlers::virtualization as u64, 0);
    _IDT[30] = IDTEntry::init_entry(isr_handlers::security_exception as u64, 0);
